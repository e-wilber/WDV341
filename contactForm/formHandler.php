...
$to = "contact@erinwilber.org";  // Your Heartland-hosted email address
$subject = "New Contact Request - $contactReason";

// Prepare email headers
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/plain;charset=UTF-8" . "\r\n";  // Use text/plain for now, can switch to text/html later
$headers .= "From: contact@erinwilber.org";  // Use your domain email
...
$confirmationHeaders .= "From: contact@erinwilber.org";  // Use your domain email
